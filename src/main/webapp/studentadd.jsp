...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  input[type="text"], input[type="number"], input[type="date"] {
    ...
    color: white; font-size: 0.95rem; transition: all 0.3s; outline: none; }
  ...
  <div class="form-card">
    ...
    <form action="AddStudent" method="post" id="addForm" novalidate>
      ...
      <div class="row-2">
        ...
        <!-- AUTO-INCREMENT ID: readonly, fetched from DB -->
        <div class="field">
        ...
        <div class="field">
          ...
          <input type="text" name="studentName" id="studentName" placeholder="e.g. Rahul Sharma">
